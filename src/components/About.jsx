...
const About = () => {
  return (
      <div name='about' className='w-full h-full bg-gradient-to-b from-gray-800 to-black text-white pt-40 '>
          <div className='max-w-screen-lg p-4 mx-auto flex flex-col w-full h-full justify-center' >
              ...
              <br/>
              <p className='text-xl'>
                  I love exploring new technologies and contributing my best in work and team.
                  Even if I couldn't accomplish things I believe in consistency.
                  Other than my Web Development I like to interact with new people and try to learn from them.
              </p>
          </div>
    </div>
  )
